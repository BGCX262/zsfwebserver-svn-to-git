...
public class HibernateGameLogFactory {

	private static final ThreadLocal<Session> sessions = new ThreadLocal<Session>();
	private static final Log log = LogFactory.getLog(HibernateGameLogFactory.class);
	private static final String absolutePath = "config/hibernateGameLog.cfg.xml";
	private static SessionFactory sessionFactory;
	
	static{
		new HibernateGameLogFactory(absolutePath);
	}
	
	public HibernateGameLogFactory(String fileName) {
