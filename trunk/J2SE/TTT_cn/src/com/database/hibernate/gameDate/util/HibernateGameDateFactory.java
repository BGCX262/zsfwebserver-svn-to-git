package com.database.hibernate.gameDate.util;
...
public class HibernateGameDateFactory {

	private static final ThreadLocal<Session> sessions = new ThreadLocal<Session>();
	private static final Log log = LogFactory.getLog(HibernateGameDateFactory.class);
	private static final String absolutePath = "config/hibernateGameDate.cfg.xml";
	private static SessionFactory sessionFactory;
	
	static{
		new HibernateGameDateFactory(absolutePath);
	}
	
	public HibernateGameDateFactory(String fileName) {
