...
public abstract class AbstractChannelSession extends AbstractSession {
    ...
    public synchronized Future start() {
        ...
        if (startFuture == null) {
            try {
            	// 启动时ServerSocketChannelSession.dostart()方法，用户连接时是SocketChannelSession;
                doStart();
            } catch (IOException e) {
                dispatchException(e);
                return new DefaultFuture(this, false);
    ...
    protected abstract class ChannelReactorHandler implements ReactorHandler {
        ...
        private void clearSendQueue() {
            synchronized (sendQueue) {
                if (currentSendPacket != null && currentSendPacket.future != null) {
                	// Changed by XiaoJun 2009-05-17
        ...
        public void onRegistered() {
            ...
            dispatch(new Runnable() {
                ...
                public void run() {
                    ...
                    // 对当前连接建立一个默认的filterChain，并调用启动会话。
